...
DAT$Nhietdo_A1 <- DAT$Nhietdo_A1/10
DAT$Nhietdo_A2 <- DAT$Nhietdo_A2/10
DAT$Nhietdo_A3 <- DAT$Nhietdo_A3/10
DAT$Doam_A1 <- DAT$Doam_A1/10
DAT$Doam_A2 <- DAT$Doam_A2/10
DAT$Doam_A3 <- DAT$Doam_A3/10
DAT$DA_A1_MIN <- DAT$DA_A1_MIN/10
DAT$DA_A2_MIN <- DAT$DA_A2_MIN/10
DAT$DA_A3_MIN <- DAT$DA_A3_MIN/10
DAT$DA_A1_MAX <- DAT$DA_A1_MAX/10
DAT$DA_A2_MAX <- DAT$DA_A2_MAX/10
DAT$DA_A3_MAX <- DAT$DA_A3_MAX/10
DAT$ND_A1_MIN <- DAT$ND_A1_MIN/10
DAT$ND_A2_MIN <- DAT$ND_A1_MIN/10
DAT$ND_A3_MIN <- DAT$ND_A1_MIN/10
DAT$ND_A1_MAX <- DAT$ND_A1_MAX/10
DAT$ND_A2_MAX <- DAT$ND_A2_MAX/10
DAT$ND_A3_MAX <- DAT$ND_A3_MAX/10
...
if(realtimeDAT$Nhietdo_A1 > CONTROL$ND_A1_MAX){
  ...
  write.table(realtimeDAT$Nhietdo_A1/10,file.path(PWD,"warning.txt"),quote = F,sep = ">",row.names=FALSE, col.names=FALSE, eol=">", append =TRUE)
  write.table(CONTROL$ND_A1_MAX/10,file.path(PWD,"warning.txt"),quote = F,sep = "\t",row.names=FALSE, col.names=FALSE, eol="\n", append =TRUE)
}
...
if(realtimeDAT$Nhietdo_A2 > CONTROL$ND_A2_MAX){
  ...
  write.table(realtimeDAT$Nhietdo_A2/10,file.path(PWD,"warning.txt"),quote = F,sep = ">",row.names=FALSE, col.names=FALSE, eol=">", append =TRUE)
  write.table(CONTROL$ND_A2_MAX/10,file.path(PWD,"warning.txt"),quote = F,sep = "\t",row.names=FALSE, col.names=FALSE, eol="\n", append =TRUE)
}
...
if(realtimeDAT$Nhietdo_A3 > CONTROL$ND_A3_MAX){
  ...
  write.table(realtimeDAT$Nhietdo_A3/10,file.path(PWD,"warning.txt"),quote = F,sep = ">",row.names=FALSE, col.names=FALSE, eol=">", append =TRUE)
  write.table(CONTROL$ND_A3_MAX/10,file.path(PWD,"warning.txt"),quote = F,sep = "\t",row.names=FALSE, col.names=FALSE, eol="\n", append =TRUE)
}
...
if(realtimeDAT$Doam_A1 < CONTROL$DA_A1_MIN){
  ...
  write.table(realtimeDAT$Doam_A1/10,file.path(PWD,"warning.txt"),quote = F,sep = "<",row.names=FALSE, col.names=FALSE, eol="<", append =TRUE)
  write.table(CONTROL$DA_A1_MIN/10,file.path(PWD,"warning.txt"),quote = F,sep = "\t",row.names=FALSE, col.names=FALSE, eol="\n", append =TRUE)
}
...
if(realtimeDAT$Doam_A2 < CONTROL$DA_A2_MIN){
  ...
  write.table(realtimeDAT$Doam_A2/10,file.path(PWD,"warning.txt"),quote = F,sep = "<",row.names=FALSE, col.names=FALSE, eol="<", append =TRUE)
  write.table(CONTROL$DA_A2_MIN/10,file.path(PWD,"warning.txt"),quote = F,sep = "\t",row.names=FALSE, col.names=FALSE, eol="\n", append =TRUE)
}
...
if(realtimeDAT$Doam_A3 < CONTROL$DA_A3_MIN){
  ...
  write.table(realtimeDAT$Doam_A3/10,file.path(PWD,"warning.txt"),quote = F,sep = "<",row.names=FALSE, col.names=FALSE, eol="<", append =TRUE)
  write.table(CONTROL$DA_A3_MIN/10,file.path(PWD,"warning.txt"),quote = F,sep = "\t",row.names=FALSE, col.names=FALSE, eol="\n", append =TRUE)
}
